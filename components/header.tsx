  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-white px-4 shadow-sm md:px-6">
      ...
      <div className="flex items-center gap-4">
        <Button
          variant="default"
          className="hidden primary-gradient button-hover md:flex"
          size="sm"
        >
              ...
              {[1, 2, 3].map((i) => (
                ...
                >
                  ...
                  <div className="text-sm text-muted-foreground">
                    تم تسليم الشحنة بنجاح إلى العميل
                  </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="cursor-pointer text-[#e05d34] hover:text-red-500">
