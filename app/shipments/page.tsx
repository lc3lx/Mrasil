...
const [searchQuery, setSearchQuery] = useState(trackingParam || phoneParam || "");
...
const filteredShipments = shipments.filter((shipment) => {
  ...
  if (searchQuery) {
    ...
    const mobileMatch = shipment.senderAddress?.mobile?.replace(/\D/g, '').includes(query.replace(/\D/g, ''))
              ...
              <Tabs defaultValue="all" className="w-full " onValueChange={setActiveTab}>
                <div className="  flex flex-col lg:flex-row justify-between gap-4  mb-6 ">
                  <TabsList className="v7-neu-tabs" dir="rtl">
                    <TabsTrigger value="all" className="v7-neu-tab text-base  sm:text-lg text-gry">
                      جميع الشحنات
                    </TabsTrigger>
                    <TabsTrigger value="active" className="v7-neu-tab  text-base sm:text-lg text-gry ">
                      النشطة
                    </TabsTrigger>
                    <TabsTrigger value="delivered" className="v7-neu-tab  text-base sm:text-lg text-gry ">
                      المسلمة
                    </TabsTrigger>
                    <TabsTrigger value="processing" className="v7-neu-tab  text-base sm:text-lg text-gry ">
                      قيد المعالجة
                    </TabsTrigger>
                  </TabsList>

                  <div className="flex gap-2" dir="rtl">
                    <div className="relative v7-neu-input-container flex-1 sm:min-w-[240px]">
