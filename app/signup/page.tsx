                    ...
                    <div className="text-xs text-white/70 space-y-0.5 rtl">
                      <div
                        className={`flex items-center gap-1.5 ${
                          passwordStrength.checks.length ? "text-green-300" : ""
                        }`}
                      >
                      ...
                      <div
                        className={`flex items-center gap-1.5 ${
                          passwordStrength.checks.number ? "text-green-300" : ""
                        }`}
                      >
                        <span className="text-xs">
          ...
          <div className="space-y-6 text-right rtl">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                تحرص منصة مراسيل على حماية خصوصية عملائها، وتلتزم بالحفاظ على
                سرية المعلومات والبيانات الشخصية وفقًا لأنظمة المملكة العربية
                السعودية، وعلى رأسها نظام حماية البيانات الشخصية الصادر عن
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-2">
                نقوم بجمع البيانات التالية فقط لأغراض تشغيل المنصة وتحسين
                الخدمة:
              </p>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 mr-4">
                ...
                <li>
                  التحليل الداخلي لتحسين تجربة المستخدم وتطوير خدمات المنصة.
                </li>
                <li>
                  إرسال إشعارات أو عروض ترويجية تتعلق بخدمات منصة مراسيل فقط،
                  وعند تسجيلك بالمنصة فأنت توافق على ذلك.
                </li>
                <li>
                  يمكن للمستخدم إلغاء الاشتراك في الرسائل الإعلانية في أي وقت من
                  خلال إعدادات الحساب أو عبر التواصل معنا مباشرة.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-2">
                لا نقوم بمشاركة بيانات العملاء مع أي طرف ثالث إلا في الحالات
                التالية:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-700 mr-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 mr-4">
                ...
                <li>
                  طلب حذف بياناته (ما لم تكن لازمة لحفظ السجلات حسب الأنظمة)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                يحق لنا تعديل هذه السياسة في أي وقت، وسيتم نشر التعديلات عبر
                منصتنا الرسمية مع تحديد تاريخ التحديث.
              </p>
            </div>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 text-right rtl">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                تمثل هذه الشروط والأحكام اتفاقًا رسميًا بين منصة مراسيل والشركات
                أو المؤسسات التي ترغب في استخدام خدمات المنصة. باستخدامك المنصة،
                فإنك توافق على الالتزام بهذه الشروط والأحكام بالكامل. إذا كنت لا
                توافق على أي بند من هذه الشروط، يجب عدم الاشتراك في المنصة أو
                استخدام أي من خدماتها.
              </p>
              <p className="text-gray-700 leading-relaxed mt-2">
                <strong>تنويه:</strong> منصة مراسيل تعمل كوسيط تقني بين المتاجر
                وشركات الشحن، ولا تمتلك أسطول شحن خاص بها.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 mr-4">
                <li>
                  <strong>منصة مراسيل:</strong> النظام الإلكتروني الذي يتيح
                  للمشتركين إدارة شحناتهم والتواصل مع شركات الشحن، مع إضافة
                  الذكاء الاصطناعي في إنشاء الشحنات، وتتبعها، وحل مشاكل الشحن.
                </li>
                <li>
                  <strong>المشترك/المتجر/الشركة:</strong> الجهة التجارية المسجلة
                  في المنصة وتستخدم خدماتها لتقديم الشحن لعملائها.
                </li>
                <li>
                  <strong>الحساب:</strong> الحساب الخاص بالمتجر في منصة مراسيل.
                </li>
                <li>
                  <strong>الشحنة/الطرود:</strong> المنتجات أو البضائع التي يتم
                  شحنها من قبل المتجر عبر شركات الشحن المعتمدة في المنصة.
                </li>
                <li>
                  <strong>شركة الشحن:</strong> أي شركة تقدم خدمات الشحن والتوصيل
                  داخل المملكة العربية السعودية أو خارجها، ومربوطة بالمنصة.
                </li>
                <li>
                  <strong>الخدمة:</strong> أي ميزة مقدمة من منصة مراسيل، بما في
                  ذلك إنشاء الشحنات، تتبع الطرود، الدفع عند الاستلام، الدعم عبر
                  الذكاء الاصطناعي، الربط مع منصات المتاجر الإلكترونية، وغيرها.
                </li>
                <li>
                  <strong>العميل النهائي:</strong> المستفيد من خدمات الشحن التي
                  يقدمها المتجر عبر منصة مراسيل.
                </li>
                <li>
                  <strong>القوانين المعمول بها:</strong> الأنظمة واللوائح
                  السعودية السارية، بما في ذلك اللوائح التنظيمية المتعلقة بالنقل
                  والشحن وحماية البيانات.
                </li>
              </ul>
            </div>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">
                3. الاشتراك في منصة مراسيل
              </h4>
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                <li>
                  يجب أن يكون المتجر أو المؤسسة مرخصًا ويعمل وفق الأنظمة
                  السعودية.
                </li>
                <li>يلتزم المشترك بتقديم بيانات صحيحة وكاملة عند التسجيل.</li>
                <li>
                  لا يحق للمشترك استخدام المنصة لأي نشاط غير قانوني أو مخالف
                  للأنظمة.
                </li>
                <li>
                  منصة مراسيل تحتفظ بحق تعليق أو إلغاء الحساب في حال المخالفة.
                </li>
              </ol>
              <p className="text-gray-700 leading-relaxed mt-2">
                <strong>رسوم الاشتراك:</strong> حاليًا، الاشتراك مجاني، ويمكن
                إضافة الرسوم مستقبلًا وفق إشعار مسبق.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                <li>
                  <strong>وسيط شحن:</strong> تربط المنصة المتاجر بشركات الشحن
                  دون تحمل أي مسؤولية عن فقد، تلف، أو تأخير الشحنة.
                </li>
                <li>
                  <strong>الدفع عند الاستلام:</strong> إدارة خيارات الدفع بما في
                  ذلك الدفع عند الاستلام.
                </li>
                <li>
                  <strong>التتبع وإشعارات العملاء:</strong> إمكانية تتبع الطرود
                  وإرسال تحديثات تلقائية للعملاء.
                </li>
                <li>
                  <strong>الذكاء الاصطناعي:</strong> دعم العملاء في إنشاء
                  الشحنات، متابعة الشحن، حل مشاكل التوصيل، وتقديم المساعدة في
                  الوقت الفعلي.
                </li>
                <li>
                  <strong>ربط API مع منصات المتاجر:</strong> تمكين المشترك من
                  إدارة الشحنات مباشرة من متجره الإلكتروني.
                </li>
                <li>
                  <strong>الدعم الفني:</strong> توفير المساعدة وحل النزاعات
                  المتعلقة بالشحن مع شركات الشحن.
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                <li>
                  إدخال بيانات صحيحة للشحنات، بما في ذلك الوزن والأبعاد ومحتوى
                  الطرد.
                </li>
                ...
                <li>
                  تحمل المسؤولية عن أي خسائر ناتجة عن سوء استخدام النظام أو
                  تقديم بيانات مضللة.
                </li>
              </ol>
            </div>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">
                6. مسؤولية منصة مراسيل
              </h4>
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                <li>تقديم منصة تقنية لربط المتاجر مع شركات الشحن.</li>
                <li>
                  إدارة وإتاحة خدمات الدفع عند الاستلام، التتبع، وربط API.
                </li>
                <li>دعم العملاء ومساعدتهم في حل المشاكل.</li>
              </ol>
              <p className="text-gray-700 leading-relaxed mt-2">
                <strong>تنويه:</strong> المنصة غير مسؤولة عن أي فقد، تلف، تأخير،
                أو تقصير من شركات الشحن.
              </p>
            </div>

            <div>
              <h4 className="text-lg font-semibold mb-2">
                7. احتساب الوزن والفوترة
              </h4>
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                <li>الوزن الفعلي والحجمي يُحتسب وفقًا لمعايير شركات الشحن.</li>
                <li>
                  أي اختلاف بين البيانات المعلنة والوزن الفعلي يؤدي إلى تعديل
                  الفاتورة أو رفض الشحنة.
                </li>
                <li>
                  منصة مراسيل تحتفظ بحق خصم أي فروقات مالية من رصيد المشترك أو
                  الدفع عند الاستلام.
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                ...
                <li>
                  يحظر على المشترك تعديل أو نسخ أو استخدام أي محتوى أو عناصر
                  تقنية إلا وفق الأغراض المصرح بها.
                </li>
                <li>
                  عند إنهاء الاشتراك، يلتزم المشترك بالتوقف فورًا عن استخدام أي
                  من موارد المنصة.
                </li>
              </ol>
            </div>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">
                10. القانون المعمول به وحل النزاعات
              </h4>
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mr-4">
                <li>تخضع هذه الشروط للقوانين واللوائح السعودية.</li>
                <li>
                  تكون المحاكم المختصة في المملكة العربية السعودية هي الجهة
                  القضائية للنظر في أي نزاع.
                </li>
                <li>
                  تُعتبر جميع الرسائل والتواصل الإلكتروني بين المتجر ومنصة
                  مراسيل ذات حجية قانونية قائمة بحد ذاتها، وتعد ملزمة قانونيًا
                  للطرفين.
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                تحتفظ منصة مراسيل بحق تعديل الشروط والأحكام أو الرسوم في أي وقت،
                ويُعتبر استمرار استخدام المنصة بعد التعديل موافقة على التحديثات.
              </p>
            </div>
            ...
            <div className="pt-4 border-t">
              ...
              <p className="text-gray-700">
                إذا كانت لديك أي أسئلة حول شروط وأحكام الاشتراك، يرجى الاتصال
                بنا عبر info@marasil.sa أو عبر الرقم 966500556618
              </p>
            </div>
          </div>
        </DialogContent>
