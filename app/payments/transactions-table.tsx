      ...
      <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 mb-4">
        ...
        <div className="flex gap-2 w-full md:w-auto justify-end">
          <Select defaultValue="all">
            <SelectTrigger className="w-full md:w-[180px] v7-neu-input pe-4 flex items-center justify-between bg-white dark:bg-gray-800 text-[#294D8B] dark:text-blue-400 font-medium shadow-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-2 border-[#294D8B] dark:border-blue-500" dir="rtl">
              <SelectValue placeholder="نوع المعاملة" />
              <Filter className="h-4 w-4 ml-2" />
            </SelectTrigger>
            <SelectContent className="dark:bg-gray-800  bg-[#f0f4f8] border-none " dir="rtl">
        ...
        <div className="relative flex-grow md:flex-grow-0 md:w-64">
          ...
          <Input placeholder="بحث في المعاملات..." className="v7-neu-input-hollow pr-12  text-gry  dark:bg-gray-800 dark:text-gray-200"  dir="rtl"/>
        </div>
      </div>
          ...
          <table className="w-full" dir="rtl">
            ...
            <tbody className=" dark:bg-gray-800">
              ...
              {data && data.data && data.data.map((trx) => (
                <tr key={trx._id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-[#f0f4f8] dark:hover:bg-gray-700">
