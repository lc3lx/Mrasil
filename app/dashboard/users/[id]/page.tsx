            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-4xl font-bold text-gray-900 mb-3">{shipments.length.toLocaleString()}</p>
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600 mb-2">إجمالي المصروفات</p>
                      <p className="text-4xl font-bold text-gray-900 mb-3">{totalSpent.toLocaleString()}</p>
                      <div className="flex items-center">
                        <CreditCard className="w-4 h-4 text-emerald-500 ml-1" />
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-4xl font-bold text-gray-900 mb-3">{orders.length.toLocaleString()}</p>
                      <div className="flex items-center">
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600 mb-2">رصيد المحفظة</p>
                      <p className="text-4xl font-bold text-gray-900 mb-3">{(wallet?.balance ?? 0).toLocaleString()}</p>
                      <div className="flex items-center">
                        <Wallet className="w-4 h-4 text-amber-500 ml-1" />
