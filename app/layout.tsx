...
export const metadata: Metadata = {
  title: "Marasil",
  description:
    "أول منصة شحن في العالم مدعومة بالذكاء الاصطناعي، تجمع لك أفضل شركات الشحن بأسعار تنافسية، وتتيح لك مقارنة الأسعار، وطباعة البوالص، وتتبع الشحنات بسرعة وذكاء",
  keywords: [
    "شحن",
    "لوجستيات",
    "توصيل",
